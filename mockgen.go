...
//go:generate sh -c "mockgen -package quic -self_package github.com/sagernet/quic-go -destination mock_token_store_test.go github.com/sagernet/quic-go TokenStore"
//go:generate sh -c "mockgen -package quic -self_package github.com/sagernet/quic-go -destination mock_packetconn_test.go net PacketConn"

...
var (
	...
	retryAEAD    cipher.AEAD // used for QUIC draft-34 and upwards
...
func init() {
	...
	retryAEADV2 = initAEAD([16]byte{0xba, 0x85, 0x8d, 0xc7, 0xb4, 0x3d, 0xe5, 0xdb, 0xf8, 0x76, 0x17, 0xff, 0x4a, 0xb2, 0x53, 0xdb})
}
...
var (
	...
	retryNonceV2  = [12]byte{0x14, 0x1b, 0x99, 0xc2, 0x39, 0xb0, 0x3e, 0x78, 0x5d, 0x6a, 0x2e, 0x9f}
)
...
func GetRetryIntegrityTag(retry []byte, origDestConnID protocol.ConnectionID, version protocol.VersionNumber) *[16]byte {
	...
	} else if version != protocol.Version1 {
